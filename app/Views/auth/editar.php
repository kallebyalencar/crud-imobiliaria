...
<head>
    ...
    <link rel="stylesheet" href="<?= $base ?>/assets/css/editar.css">
</head>
<body>
...
<main class="editar-page">
    <section class="editar-card">
        ...
        <form action="<?= $base ?>/editar-perfil" method="POST" enctype="multipart/form-data">
            <section class="imagens-perfil">
                <div class="campo-imagem capa-edicao">
                    <label>Foto de capa</label>
                    <div class="preview-capa"><span>Imagem de capa</span></div>
                    <input type="file" name="foto_capa">
                </div>
                <div class="campo-imagem foto-edicao">
                    <label>Foto do vendedor</label>
                    <div class="preview-foto">
                        <img src="<?= $base ?>/assets/img/logo.jpeg" alt="Preview">
                    </div>
